...
type ProjectSearch struct {
	Search
	MatchModes []MatchMode `json:"matchModes,omitempty"`
...
// GetMatchModes returns the MatchModes field value if set, zero value otherwise.
func (o *ProjectSearch) GetMatchModes() []MatchMode {
	if o == nil || IsNil(o.MatchModes) {
		var ret []MatchMode
		return ret
	}
	return o.MatchModes
...
// GetMatchModesOk returns a tuple with the MatchModes field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ProjectSearch) GetMatchModesOk() ([]MatchMode, bool) {
	if o == nil || IsNil(o.MatchModes) {
		return nil, false
	}
	return o.MatchModes, true
}
...
// SetMatchModes gets a reference to the given []MatchMode and assigns it to the MatchModes field.
...
func (o ProjectSearch) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.MatchModes) {
		toSerialize["matchModes"] = o.MatchModes
	}
