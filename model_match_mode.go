...
// MatchMode Defines the level of keyword matching required.
type MatchMode string

// List of MatchMode
const (
	ALL_MATCH MatchMode = "ALL_MATCH"
	SOME_MATCH MatchMode = "SOME_MATCH"
	INDIRECT_MATCH MatchMode = "INDIRECT_MATCH"
)
